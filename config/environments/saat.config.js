module.exports = {
    services: {
        ...
        ccd_def_api: 'https://ccd-definition-store-api-saat.service.core-compute-saat.internal',
        ...
        draft_store_api: 'https://draft-store-service-saat.service.core-compute-saat.internal',
        dm_store_api: 'https://dm-store-saat.service.core-compute-saat.internal',
