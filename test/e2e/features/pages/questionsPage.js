...
function questionsPage() {
    this.questions_header = element(by.css('h1.govuk-heading-l'));
    this.add_questions_btn = element(by.css('[data-selector="no-draft-questions-link"]'));
    this.no_draft_questions_text = element(by.css('[data-selector="no-draft-questions-details"]'));
    this.no_draft_question_btn = element(by.css('[data-selector="no-draft-questions-link"]'));
