    ...
    groups: [
        ...
        },
        {
            information: {
                ...
                enhancedRate: 'Enhanced rate'
            }
        },
        {
            heading: {
                text: 'Reasons for the tribunal’s view',
                classes: 'govuk-heading-l govuk-!-margin-top-8'
            }
        },
        {
            reasons: 'reasons for tribunal'
        },
        {
            heading: {
                text: 'PIP activities and the descriptors we consider apply to your appeal',
                classes: 'govuk-heading-l'
            }
        },
        {
        ...
        {
            statictext: {
                text: 'You can accept the view or if you feel the view is wrong you can have a face to face hearing.'
            }
        },
        {
            hr: {}
