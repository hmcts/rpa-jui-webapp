...
const idamS2SUrl = process.env.S2S_URI || 'http://rpe-service-auth-provider-aat.service.core-compute-aat.internal';
const microservice = process.env.JUI_MICROSERVICE || process.env.APPSETTING_JUI_MICROSERVICE || "divorce_document_upload";
const secret = process.env.JUI_SECRET || process.env.APPSETTING_JUI_SECRET || "AAAAAAAAAAAAAAAA";
